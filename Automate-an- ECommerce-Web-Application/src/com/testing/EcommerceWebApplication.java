...
public class EcommerceWebApplication {
	...
	public void Start(String browser) throws Exception {
		...
		if (browser.equalsIgnoreCase("Chrome")) {
			...
			System.setProperty("webdriver.gecko.driver",
					"C:\\Users\\USER\\Downloads\\geckodriver-v0.31.0-win64\\geckoodriver.exe");
	...
	public void search() {
		...
		WebElement i = webdriver.findElement(By.xpath("//img[@alt='APPLE iPhone 13 (Midnight, 128 GB)']"));

		Boolean image = (Boolean) ((JavascriptExecutor) webdriver).executeScript("return arguments[0].complete "
